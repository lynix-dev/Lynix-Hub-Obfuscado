-- Tela de Loading (Roxo + Gradiente Cinza)
...
background.BackgroundColor3 = Color3.fromRGB(100, 0, 150)
background.BorderSizePixel = 0
background.Parent = screenGui

-- Gradiente suave cinza
...
progressBarBg.BackgroundColor3 = Color3.fromRGB(60, 0, 100)
...
-- Arredondamento
local corner1 = Instance.new("UICorner", progressBarBg)
...
for i = 1, 30 do
	...
	loadingText.TextTransparency = i / 30
	progressBarBg.BackgroundTransparency = i / 30
	progressBar.BackgroundTransparency = i / 30
	wait(0.03)
end
...
local InfoTab = Window:MakeTab({ Title = "Info", Icon = "rbxassetid://92938877761950" })



InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Owner / Developer:", "Lynix, Rick, Void777" })
InfoTab:AddParagraph({ "Colaborações:", "Rick " })
InfoTab:AddParagraph({ "Você está usando:", "Lynix Hub Brookhaven " })
...
Tab1:AddDiscordInvite({
    Name = "Lynix | Studios ",
    Description = "https://discord.gg/qaw9TfxFY2",
...
local Paragraph = Tab1:AddParagraph({"Criadores", "Void777 \n ?????"})
  ...
  Tab1:AddButton({
    ...
    Callback = function()
      ...
      setclipboard("https://www.tiktok.com/@Void777?_t=ZM-8wFjhRHkmOd&_r=1") -- Copia o link também, se quiser só o @, remova esta linha
